...
const Login = () => {
    ...
    return (
        <div className="h-screen flex justify-center items-center bg-gray-900 dark:bg-gray-900 relative">
            ...
            <form
                onSubmit={onSubmit}
                className="relative z-10 w-full max-w-md p-8 rounded-xl shadow-xl bg-gray-100 dark:bg-gray-900 border border-gray-100 dark:border-gray-600 transition-colors"
            >
